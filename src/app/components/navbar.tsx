...
function NavLink  ({ href, children }: {href: string, children: React.ReactNode}) {
 ...
 return (   <Link href={href}>
        <span className="text-purple-300 hover:text-purple-500 transition-colors">{children}</span>
    </Link>)
}
    ...
    return (
        <nav className="flex flex-row bg-structure-gray rounded-full min-w-[450px] h-[60px] items-center backdrop-blur">
            ...
            <div className="flex space-x-4">
                <SocialIcon href="https://github.com/uwumarogie" src="/icons/github.svg" alt="GitHub" />
                <SocialIcon href="https://www.linkedin.com/in/phillips-uwumarogie-80b56ab1/" src="/icons/linkedin.svg" alt="LinkedIn" />
