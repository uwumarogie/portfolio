...
export default function Introduction() {
    return (
        <div className="flex flex-row justify-center items-center space-x-52">
          ...
          A <strong className="text-white">Full Stack Software Engineer</strong> and{" "}
                    <strong className="text-white">CS Student</strong> with real world experience.
                    I craft code that brings ideas to life.
          Let's build the future together.
            ...
            <div className="">
                <Image src="/images/photo-of-me.png" alt="Photo of Phillips Uwumarogie"
